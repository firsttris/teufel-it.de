<template>
  <div>
    <mainComponent :heading="headingJson" :portfolio="portfolioJson" :principles="principlesJson">
    </mainComponent>
  </div>
</template>
<script>
  import mainComponent from './Main.vue'
  import headingJson from './../assets/json/development/heading.json'
